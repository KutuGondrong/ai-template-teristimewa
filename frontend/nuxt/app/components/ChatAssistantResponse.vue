...
/** Dots + label while waiting or inside a reasoning block, before answer text arrives. */
const showThinkingIndicator = computed(
  () => props.streaming && !showResponse.value && parsed.value.phase !== "responding",
);
/** Reasoning body from think/redacted_thinking tags, smaller than the answer. */
